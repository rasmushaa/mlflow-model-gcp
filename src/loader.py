...
class DataLoader:
    ...
    def __init__(
        ...
        self.__mock = mock
        logger.debug(
            f"Inited DataLoader with start_date={self.__start_date}, end_date={self.__end_date}, mock={self.__mock}"
        )
    ...
    def sql(self) -> str:
        ...
        """
        start_filtter = (
            f"AND KeyDate >= '{self.__start_date}'" if self.__start_date else ""
        )
