...
class TestDataLoader(unittest.TestCase):
    ...
    def test_load_return_value(self):
        ...
        with patch('src.data.loader.pandas_gbq.read_gbq', side_effect=self.__query_mock_database):
            result = loader.load()
    ...
    def __query_mock_database(self, query: str, project_id: str, location: str, progress_bar_type):
        ...
        con.execute(f"CREATE TABLE {os.getenv('GCP_BQ_DATASET')}.f_transactions AS SELECT * FROM f_transactions")
