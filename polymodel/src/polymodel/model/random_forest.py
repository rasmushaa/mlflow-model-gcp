...
class RandomForestModel(RandomForestClassifier):
    ...
    def features(self) -> list:
        ...
        if hasattr(self, 'feature_names_in_'):
            ...
            raise AttributeError("The model has not been fitted yet, so feature names are unavailable.")
    ...
    def classes(self) -> list:
        ...
        if hasattr(self, 'classes_'):
            ...
            raise AttributeError("The model has not been fitted yet, so classes are unavailable.")